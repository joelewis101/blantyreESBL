...
Minor syntax changes due to dependency changes

### Changed

- Updated readme with published paper doi
- Changed subset_tree (is now in tidytree package)
- Changed dplyr::slice calls to latest syntax
