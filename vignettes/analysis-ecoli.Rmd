...
*A genomic analysis of extended-spectrum beta-lactamase producing E. coli colonising adults in Blantyre, Malawi demonstrates unsampled diversity compared to a representative global collection*
...
if (write_figs) {
  ggsave(
    here("figures/ecoli-genomics/mlst_plot.pdf"),
    mlst_plot,
    width = 7,
    height = 4)
  ggsave(
    here("figures/ecoli-genomics/mlst_plot.svg"),
    mlst_plot,
    width = 7,
    height = 4)
}
...
```{r plasmidreplicon_prev, fig.width = 4, fig.height=4}
...
if (write_figs) {
  ...
  ggsave(
    here("figures/ecoli-genomics/ecoli_plasmid_replicon_prevalence.pdf"),
    plasm_rep_prev,
    width = 4,
    height = 4)
  ggsave(
    here("figures/ecoli-genomics/ecoli_plasmid_replicon_prevalence.svg"),
    plasm_rep_prev,
    width = 4,
    height = 4)
