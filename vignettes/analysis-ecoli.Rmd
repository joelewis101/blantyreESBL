...
(  
  (ggtree(
    treeio::tree_subset(btESBL_ecoli_globalst410_tree_noASC,
                         1085,
                         levels_back = 0)) %<+% 
...
treeio::tree_subset(
treeio::tree_subset(
  btESBL_ecoli_globalst410_tree_noASC, 1085, levels_back = 0),
...
(ggtree(treeio::tree_subset(
  btESBL_ecoli_globalst167_tree_noASC, 321, levels_back = 0)) %<+% 
...
```{r subrtree-plots, fig.height= 11, fig.width = 9, fig.cap = "E. coli ST140 (A) and ST167 (B) subtrees showing ESBL/CPE genes and plasmid mreplicons"}
...
ggsave(here("figures/ecoli-genomics/st410_167_subtreeplot.svg"),
       st410_167_subtree_plot, width = 9, height = 11)
