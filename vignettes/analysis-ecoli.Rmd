...
```{r globalvsmalawi_pgroup, fig.width = 5, fig.height = 4, fig.cap = "Phylogroup distribution in isolates from this study comapred to the global collection"}
...
(  
  ...
  geom_treescale(x = 0.0002, y = 250, offset = 5) +
   geom_highlight(node = 695 ,alpha = 0.3) +
  geom_cladelabel(
    node = 695,
    label = "B4/H24RxC",
    angle = 90,
...
treeio::tree_subset(
treeio::tree_subset(
  btESBL_ecoli_globalst410_tree, 1085, levels_back = 0),
695,levels_back = 0) -> st410_subtree
...
st410_plasm_onehot %>%  
  ...
  (ggtree(st410_subtree) %<+% (select(st410_metadata, accession, Country) %>% mutate(Country = if_else(Country == "Malawi", "Malawi",NA_character_)))  %>%
     ...
     scale_fill_viridis(name = "Year", limits = c(1965,2020)) +
     new_scale_fill()) %>% 
    gheatmap(
      select(st410_metadata, Continent),
      font.size = 4,
  ...
  gheatmap(
    ...
    hjust = 0
                        ...
                        name = "Plasmid\nreplicon") +
  ylim(NA, 180) +
  geom_treescale(x = 0.000002, y = 165, offset = 2,width = 1e-5) -> st410_subtree_plot
    # geom_highlight(node = 149 , alpha = 0.3) +
    # geom_cladelabel(
    #   node = 149,
    #   label = "B4/H24RxC",
    #   angle = 90,
...
(ggtree(treeio::tree_subset(
  btESBL_ecoli_globalst167_tree, 321, levels_back = 0)) %<+% 
  ...
  #                       name = "Plasmid\nreplicon") +
  ylim(NA, 370) +
  geom_treescale(x = 0.00002, y = 370*0.666, offset = 2, width = 0.00001)   +
...
st167_plasm_onehot %>%  
  ...
  gheatmap(
    ...
    font.size = 3,
    width = 0.0668*(ncol(esbl_cpe.ariba167_subset) - 1),
    colnames_position = "top",
    color = NA,
    colnames_offset_y = 0,
    colnames_angle = 90,
    ...
    select(st167_plasm_onehot, -name),
    font.size = 3,
    width = 0.0668*(ncol(st167_plasm_onehot) - 1) + 0.1,
    colnames_position = "top",
    color = NA,
    colnames_offset_y = 0,
    colnames_angle = 90,
    ...
    hjust = 0
                        ...
                        name = "Plasmid\nreplicon") +
  ylim(NA, 70) +
  geom_treescale(x = 0.000006, y = 70*0.666, offset = 1, width = 1e-5) ->
    st167_subtree_plot
...
btESBL_ecoli_st131_metadata$Continent[
  btESBL_ecoli_st131_metadata$Country == "Czech"] <- "Europe"

btESBL_ecoli_st131_metadata$Continent[
  btESBL_ecoli_st131_metadata$Country == "Taiwan"] <- "Asia"
...
(
(
(ggtree(btESBL_ecoli_globalst131_tree, size = 0.3) %<+% 
  ...
  new_scale_fill()
    ...
    font.size = 3,
    width = 0.03*(ncol(st131_plasm_onehot) - 1) + 0.1,
    colnames_position = "top",
    color = NA,
    colnames_offset_y = 5,
    colnames_angle = 90,
...
```{r subrtree-plots, fig.height= 11, fig.width = 20, fig.cap = "E. coli ST140 (A) and ST167 (B) subtrees and (C) ST131 tree showing ESBL/CPE genes and plasmid replicons"}
...
ggsave(here("figures/ecoli-genomics/st410_167_subtreeplot.svg"),
       st410_167_subtree_plot, width = 20, height = 11)

ggsave(here("figures/ecoli-genomics/st410_167_131_subtreeplot.pdf"),
       st410_167_131_subtree_plot, width = 20, height = 11)
}
