...
```{r d7-prevplot, fig.width = 6, fig.height =4, fig.cap = "A: Number of stools samples collected per day stratified by arm. B: Proportion of samples per day in which ESBLE was identfied, stratified by arm." }
...
```{r manhattan-plots-sens-ax, fig.cap = "Associations of popPUNK cluster (A) and contig cluster (B) to healthcare associated isolates. Healthcare associated here is defined as either in-hospital or recent discharge (within 120 days of admission to hospital)", fig.width = 9, fig.height = 4}
